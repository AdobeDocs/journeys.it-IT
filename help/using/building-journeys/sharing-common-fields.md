...
Si tratta dei campi XDM comuni che [!DNL Journey Orchestration] invia ad Adobe Experience Platform. Verranno inviati campi comuni per ogni fase elaborata durante un viaggio. Campi più specifici vengono utilizzati per azioni personalizzate e per arricchimenti.
