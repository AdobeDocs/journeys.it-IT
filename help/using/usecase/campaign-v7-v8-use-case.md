...
# Invio di un messaggio tramite Campaign {#campaign-v7-v8-use-case}

Questo caso d’uso illustra tutti i passaggi necessari per inviare un’e-mail utilizzando l’integrazione Adobe Campaign.
...
* [Creazione di un’azione Campaign](../action/working-with-adobe-campaign.md#using_adobe_campaign_v7_v8)
* [Utilizzo dell’azione in un percorso](../building-journeys/using-adobe-campaign-actions.md).
