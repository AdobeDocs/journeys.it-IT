...
|--- |--- |
| **Azione** | Elenco di ogni azione (**nome azione - etichetta azione**) utilizzato nei percorsi, ad esempio Push - Check-out di conferma, E-mail - Fedeltà ai premi. |
| **Origine dati** | Elenco delle origini dati (**nome origine dati**) utilizzato per arricchire i dati in un percorso, ad esempio Adobe Experience Platform, Sistema di prenotazione. |
...
| **Gruppo di campi** | Elenco dei gruppi di campi (**nome gruppo di campi**) utilizzato per arricchire i dati in percorsi, ad esempio gruppo di campi Profilo, Geometrixx di prenotazione. |
...
| **Versione percorso** | Elenco di tutte le versioni pubblicate di un percorso (**Nome percorso + numero di versione** ad esempio Abbandono carrello v1, Notifica di prenotazione hotel v2. |
| **Orchestrazione** | Elenco di ogni attività di orchestrazione (**Condizione, Fine, Attesa**) definito e utilizzato nei percorsi. |
...
| **Percentuale corrente** | Numero totale di individui attualmente nel percorso rispetto al numero di individui che sono entrati nel percorso. |
| **Immesso** | Numero totale di eventi che hanno avviato una singola voce nel percorso. |
...
| **Percentuale di errori** | Numero totale di errori che si sono verificati durante un percorso rispetto al numero totale di occorrenze nel percorso. |
...
| **Percentuale errori** | Numero totale di percorsi non eseguiti correttamente rispetto al numero di percorsi di esecuzione. |
...
| **Percentuale consegne** | Numero totale di messaggi consegnati correttamente rispetto ai messaggi inviati. |
| **Errore** | Numero totale di errori che si sono verificati durante un percorso ma non hanno impedito il completamento del percorso. |
...
| **Percentuale rifiutata** | Numero totale di messaggi contrassegnati come rifiutati rispetto ai messaggi inviati. |
...
| **Annullamento iscrizione** | Numero di clic sul collegamento di annullamento dell’abbonamento. |
| **Percentuale di annullamento abbonamento** | Numero totale di annullamenti di abbonamenti per destinatario rispetto ai messaggi consegnati. |
