...
Puoi utilizzare uno dei predefiniti o crearne uno nuovo utilizzando il servizio Identity Namespace. Fai riferimento a questo [pagina](https://experienceleague.adobe.com/docs/experience-platform/identity/home.html?lang=it).

Se selezioni uno schema con un’identità primaria, il **[!UICONTROL Key]** e **[!UICONTROL Namespace]** i campi sono precompilati. Se non è stata definita alcuna identità, selezioniamo _identityMap > id_ come chiave primaria. Quindi devi selezionare uno spazio dei nomi e la chiave verrà precompilata (sotto il **[!UICONTROL Namespace]** field) utilizzando _identityMap > id_.
