...
* **[!UICONTROL Segments]**: se hai rilasciato una **[!UICONTROL Segment qualification]** , scegli il segmento da utilizzare nell’espressione. [Ulteriori informazioni](../segment/using-a-segment.md)
